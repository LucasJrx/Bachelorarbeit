...
Nach der Berechnung ergibt sich eine maximale Kraft pro Meter Schiene beim Kurzschluss von 45,43 kN/m. Diese Kraft wird auf die modellierte Schienenlänge von 0,75 m umgerechnet, daraus resultiert eine Kraft von 34,07 kN, die von der flexiblen Kupferschiene sicher aufgenommen werden muss, ohne dass es zu gravierenden Verformungen oder Beschädigungen kommt. Befestigungspunkte und Materialstärke der Schiene sind so auszulegen, dass diese Kräfte zuverlässig abgeleitet werden. Die Einwirkung kann in Inventor 2019 simuliert werden, um das Verhalten der Schiene unter dieser Belastung zu beurteilen. Dazu wird die zuvor modellierte Schiene in der Software geladen und die berechnete Kurzschlusskraft von 34,07 kN aufgebracht, die Befestigungspunkte werden berücksichtigt, um realistische Randbedingungen zu schaffen. Anschließend wird die Simulation ausgeführt und die Verformung der Schiene analysiert.
