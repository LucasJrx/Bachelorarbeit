...
Würde die Arbeit unter wissenschaftlichen Aspekten betrachtet werden, wäre ein Erkenntnisgewinn, der durch methodisches Vorgehen und Forschung erzielt worden wäre, nachvollziehbar zu dokumentieren. Der Erkenntnisgewinn selbst erfolge über die Beobachtung, Beschreibung, Erklärung und Vorhersage von Prozessen und Strukturen. Häufig würden hierzu Daten erhoben, Messungen durchgeführt und systematische Analysen vorgenommen, um den Untersuchungsgegenstand besser zu verstehen. @heesenWissenschaftlichesArbeitenMethodenwissen2021

Bezogen auf das vorliegende Projekt stünde die umfassende Analyse und Dokumentation des Order-to-Cash-Prozesses im #acrs("DC")-Schrankgeschäft der #acrs("ABB") AG im Mittelpunkt. Der zentrale Forschungspunkt wäre hierbei das Verständnis und die Optimierung der #acrs("ETO")- und #acrs("CTO")-Prozesse, die als komplexe Abläufe verschiedene Unternehmensbereiche und Akteure miteinander verbinden würden. Um den Gesamtprozess besser zu erfassen, würde dieser in Teilprozesse zerlegt, die jeweils von unterschiedlichen Teams und Verantwortlichen durchgeführt würden.

Ein wissenschaftlicher Untersuchungsansatz in diesem Kontext wäre die systematische Erhebung und Auswertung von Prozessschritten, beispielsweise durch Interviews mit den beteiligten Mitarbeitenden sowie die Analyse vorhandener Prozessdokumentationen. Die gewonnenen Informationen würden genutzt, um die Abläufe mithilfe von Swimlane-Diagrammen zu visualisieren und so Transparenz über die einzelnen Prozessschritte, Schnittstellen und Verantwortlichkeiten zu schaffen. @EinfuehrungSwimlaneDiagrammeBeispiele @HowMakeSwimlane

Ein besonderer Fokus läge auf der Identifikation von Schwachstellen, Redundanzen und Medienbrüchen, da diese Faktoren maßgeblich die Effizienz und Qualität des Gesamtprozesses beeinflussen könnten. Die enge Zusammenarbeit mit dem DC Engineering Team ermöglichte es, praxisnahe Erkenntnisse zu gewinnen und gezielt Verbesserungspotenziale zu identifizieren. Durch die strukturierte Analyse und die Ableitung von Handlungsempfehlungen würde eine Grundlage geschaffen, um gezielt Optimierungen im Order-to-Cash-Prozess zu etablieren und zukünftige Projekte effizienter zu gestalten.

Im technischen Kontext könnten im Rahmen weiterführender wissenschaftlicher Arbeiten beispielsweise digitale Tools oder Softwarelösungen untersucht werden, die die Prozessdokumentation und -steuerung unterstützen und so zur weiteren Optimierung der Abläufe beitragen würden. Als Datengrundlage dienten dabei typischerweise interne Prozessdokumente, Ablaufdiagramme und Erfahrungsberichte der beteiligten Teams. Die wissenschaftliche Herangehensweise gewährleistete, dass die Ergebnisse objektiv, nachvollziehbar und reproduzierbar wären und somit einen nachhaltigen Beitrag zur Prozessverbesserung leisten könnten.
